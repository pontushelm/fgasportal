    ...
    return NextResponse.json(
      {
        ...
        certificationIssuer: user?.certificationIssuer ?? null,
        certificationValidUntil: user?.certificationValidUntil ?? null,
        certificationCategory: user?.certificationCategory ?? null,
