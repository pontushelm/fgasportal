...
export function Sidebar() {
  ...
  return (
    <>
      <div className="sticky top-0 z-40 border-b border-slate-200 bg-white px-4 py-3 shadow-sm lg:hidden">
        <div className="flex items-center justify-between gap-3">
          <Link className="font-bold tracking-tight text-slate-950" href="/dashboard">
            FgasPortal
          </Link>
          <Button
            type="button"
        ...
        {isMobileOpen && (
          <nav className="mt-3 grid gap-1 border-t border-slate-200 pt-3">
            <NavigationLinks
      ...
      <aside className="hidden min-h-screen w-64 shrink-0 border-r border-slate-200 bg-white lg:sticky lg:top-0 lg:block lg:h-screen">
        <div className="flex h-full flex-col px-4 py-5">
          <div className="px-2">
            <Link className="text-xl font-bold tracking-tight text-slate-950" href="/dashboard">
              FgasPortal
            </Link>
